describe('Landing', () => {
  ...
  it('has QHacks crown', () => {
    cy.get('[data-cy=qhacks-crown]');
  });

  it('has QHacks wordmark', () => {
    cy.get('[data-cy=qhacks-wordmark]');
  });
  ...
  it('has date of event', () => {
    cy.get('[data-cy=qhacks-information').should('contain', 'February 1-3, 2019');
  });

  it('has QHacks tagline', () => {
    // TODO: Same apostrophe issue here
    cy.get('[data-cy=qhacks-tagline]').should('contain', 'Join us for an unforgettable experience.');
  });
