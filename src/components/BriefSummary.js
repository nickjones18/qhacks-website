...
const BriefSummary = () => (
  ...
  >
    <ContentWrapper>
      <div css={{ "@media(min-width: 820px)": { margin: "0 80px 0 80px" } }}>
        <div
          css={{
            background: "#ffffff",
            display: "grid",
        ...
        >
          ...
          >
            ...
            <p css={{ lineHeight: "24px", fontColor: "#000000" }}>
              QHacks 2018 is back for another year of collaboration, ideation,
              and creativity! More than 500 students from across North America
              will come together on February 2nd-4th for a weekend of awesome
              hacking. Attend workshops, play with hardware, take part in hacker
              challenges, and meet some new friends while turning your dreams
              into reality. Out-of-the-box thinkers, creatives, and innovators
